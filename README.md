...
Generic module manifests as MeTTa atoms, entrypoint declarations, dependencies/provides/runtime-state traces, and fixture modules.

Payload:

- `patches/04a-module-contract.patch` (1179 lines)

## Source

- Live source tree: `/home/jon/OmegaClaw/repos/OmegaClaw-Core`
- Original generated bundle: `docs/review/patch-series/patches/04a-module-contract.patch`
- Generated before the clean public Patch 1-5 stack; uploaded here for review/archaeology.

## Caveats

This is the upstream-facing boundary for shareable organs and should precede concrete organ/module branches.
