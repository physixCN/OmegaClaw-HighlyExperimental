...
Home Assistant, glucose, audio, webcam, vision, image/video generation, publishing, observation routing, terminal mirror, and dry tests.

Payload:

- `patches/04d-situated-senses-and-apps.patch` (2702 lines)

## Source

- Live source tree: `/home/jon/OmegaClaw/repos/OmegaClaw-Core`
- Original generated bundle: `docs/review/patch-series/patches/04d-situated-senses-and-apps.patch`
- Generated before the clean public Patch 1-5 stack; uploaded here for review/archaeology.

## Caveats

These should remain thin membranes and should not decide agent goals or identity.
